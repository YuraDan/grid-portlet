...
<head>
	...
	<style>
		...
		.dx-fileuploader-button .dx-button-text:after{
			content: '(кадастровый план территории в формате XML, версия 8, 9, 10)';
			display: block;
			font-size: 12px;
			margin-top: 5px;
		}
...
<div class="wrapper">
	<h1 class="site-title">
		<img alt="ГРАДИС" src="<%=request.getContextPath()%>/images/company_logo.png">
	</h1>
	<div class="banner">
		...
		<div class="topBlock">
			<h2>О системе</h2>
			ГРАДИС – это программно-аналитический комплекс, предназначенный для управления недвижимостью, выявления ошибок, приводящих к недоначислению земельного и имущественного налога, выдачи градостроительной документации, автоматизированного обмена информацией</div>
		<!-- Баннер 2 -->
